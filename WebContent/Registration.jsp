...
<body>
        ...
        <div class="container">
            ...
            <form id="register" method="post" action="RegistrationServlet" onsubmit="return validateForm();" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="number" class="form-control" id="usr6" name="Contact" placeholder="Enter contact" required min='1000000000' max='9999999999' />
    </div>
  </div>
