...
<form  name = "pickstk"  method = "post" action="LoadStkDetailsServlet">
       
       <center><h1>PICK STOCK TO UPDATE</h1></center>
               <tr>
                <br></br>      
           <table align="center" >
               
               <td>Select the Stock name:</td>
...
Connection connection = 
       ...
       resultset1 =statement.executeQuery("select distinct(name) from stock") ;
       //Set the hidden del id from previous page here 
       %>
		<td><select name = "stkname">
