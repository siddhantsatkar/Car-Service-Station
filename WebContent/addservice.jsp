...
<div class="container">
 ...
 <form id="dateRangeForm" role="form" action="AddServicetypeController" method="POST" class="form-horizontal">
 <div class="form-group">
    <label class="control-label col-sm-3" for="usr">Name</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="usr" name="service_name" placeholder="Enter servicing name" required>
    </div>
    </div>
 <div class="form-group">
    <label class="control-label col-sm-3" for="usr">Estimated time</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="usr" name="estimatedtime" placeholder="Enter the estimated time" required>
    </div>
    </div>
 <div class="form-group">
    <label class="control-label col-sm-3" for="usr">Estimated price</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="usr" name="estimatedprice" placeholder="Enter the estimated price" required>
    </div>
    </div>
 <div class="form-group">
    <label class="control-label col-sm-3" for="usr">Limit per day</label>
    <div class="col-sm-6">
      <input type="number" class="form-control" id="usr" name="maxlimit" placeholder="Enter limits per day" required>
    </div>
    </div>
