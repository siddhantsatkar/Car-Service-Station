...
<form  name = "pickemp"  method = "post" action="LoadEmpProfileServlet">
       
       <center><h1>PICK EMPLOYEE TO UPDATE</h1></center>
               <tr>
                <br></br>      
           <table align="center" >
...
Connection connection = 
       ...
       resultset1 =statement.executeQuery("select distinct(empid) from employee") ;
