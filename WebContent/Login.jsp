...
<body id="page-top" class="index">
     ...
     <div class="container">
            ...
            <form id="loginForm" method="post" action="LoginServlet" class="form-horizontal">
  ...
  <div class="col-xs-offset-3">
    ...
    <a href="Registration.jsp" class="btn btn-primary btn-md active" role="button">Sign-UP</a>
