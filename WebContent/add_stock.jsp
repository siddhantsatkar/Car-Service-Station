...
<body>
 ...
 <div class="container">
            ...
            <div class="container">
  <% if (request.getAttribute("msg2")==null) {}else{%>
    <label class="has-error control-label col-sm-3" for="usr7"></label>
    <div class="col-sm-6">
      <label id="usr7" style="color=red"><%=request.getAttribute("msg2") %></label>
    </div>
  <%} %>
  </div>
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="number" class="form-control" id="usr" name="quantity" placeholder="Enter the quantity" required>
    </div>
    </div>
 <div class="form-group">
